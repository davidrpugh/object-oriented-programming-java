...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(870, 600, P2D);  // Set up the Applet window to be 800x600
		...
		map2 = new UnfoldingMap(this, 460, 50, 350, 500, provider);
        ...
        map2.zoomAndPanTo(zoomLevel, new Location(24.8792399,46.7220684));
